...
namespace core::logger
{
    ...
    {
        // Use system time directly (UTC) to avoid dependency on tzdata/ICU which can cause crashes on MinGW if missing.
        // For local time, one would typically use std::chrono::current_zone(), but we fallback to simple reliable formatting.
        ...
        switch (level) {
            case Level::Debug: levelStr = "DBG"; colorCode = "\033[37m"; break; 
            case Level::Info: levelStr = "INF"; colorCode = "\033[32m"; break; 
            case Level::Warning: levelStr = "WRN"; colorCode = "\033[33m"; break; 
            case Level::Error: levelStr = "ERR"; colorCode = "\033[31m"; break; 
        }
